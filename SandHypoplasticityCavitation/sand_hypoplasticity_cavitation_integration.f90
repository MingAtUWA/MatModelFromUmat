...
subroutine sand_hypoplasticity_cavitation_integration(stress, ddsdde, statev, dstran, props)
    !DEC$ ATTRIBUTES DLLEXPORT::sand_hypoplasticity_cavitation_integration  
    implicit none
    ...
    call umat_hypoplasticity_cavitation(stress, statev, ddsdde,    &
...
end subroutine sand_hypoplasticity_cavitation_integration